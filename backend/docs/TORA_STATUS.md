...
- `python -m backend.check`: 1446 unit tests, 160 offline scenarios, the rules-library check.
...
`TORA_ALERT_GROUNDING_MIN_TURNS`, `TORA_ALERT_GROUNDING_RATE`, `TORA_ALERT_REQUEST_ERROR_RATE`, `TORA_ALERT_REQUEST_MIN_TOTAL`, `TORA_ALERT_TOOL_ERROR_RATE`, `TORA_ALERT_TOOL_MIN_CALLS`, `TORA_ANSWER_BLOCK`, `TORA_AUTH_CACHE_SECONDS`, `TORA_AUTH_MODE`, `TORA_AUTH_URL`, `TORA_BLOCK_ANSWER_TOKENS`, `TORA_COMPLEX_MODEL`, `TORA_COMPLEX_THINK`, `TORA_CORS_ORIGINS`, `TORA_DEBUG_ENDPOINTS`, `TORA_DIRECT_ANSWER`, `TORA_FAST_PATH`, `TORA_FINANCE_URL`, `TORA_GROUNDING_MODE`, `TORA_HOST`, `TORA_LLM_EXTRACTION`, `TORA_LLM_NUM_CTX`, `TORA_LLM_THINK`, `TORA_LLM_TIMEOUT_SECONDS`, `TORA_LOCKED_SLOTS`, `TORA_MAX_ANSWER_TOKENS`, `TORA_MODEL_CACHE_SECONDS`, `TORA_PLANNER_REPAIRS`, `TORA_PROMPT_SLICING`, `TORA_RATE_LIMIT_PER_MINUTE`, `TORA_RESEARCH_REATTEMPTS`, `TORA_SESSION_DB`, `TORA_TOOL_BREAKER_FAILURES`, `TORA_TOOL_BREAKER_SECONDS`, `TORA_TOOL_RETRIES`, `TORA_TRACE_FILE`, `TORA_TRAINING_LOG`, `TORA_TURN_MAX_ANSWER_CHARS`, `TORA_TURN_MAX_EVENTS`, `TORA_TURN_MAX_RETAINED`, `TORA_TURN_TTL_SECONDS`
