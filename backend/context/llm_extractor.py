...
ALLOWED_FACTS: Dict[str, tuple] = {
    ...
    "credit_card_min_due": ("debt", "monthly"),
    "personal_loan_emi": ("loan", "monthly"),
    "personal_loan_rate": ("loan", "interest_rate"),
    "home_loan_rate": ("loan", "interest_rate"),
    "car_loan_rate": ("loan", "interest_rate"),
    "education_loan_rate": ("loan", "interest_rate"),
    "gold_loan_rate": ("loan", "interest_rate"),
    ...
    "essential_expenses": ("expense", "monthly"),
