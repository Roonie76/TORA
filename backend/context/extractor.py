...
ENTITY_FACT_NAMES = (
    ...
    (("sip", "sips", "systematic investment plan", "systematic investment plans"), ("sip_monthly",)),
    (("fd", "fds", "fixed deposit", "fixed deposits"), ("fixed_deposit",)),
    (("ppf",), ("ppf",)),
    (("epf", "pf", "provident fund"), ("epf",)),
    (("stock", "stocks", "shares", "equity"), ("stocks",)),
    (("insurance", "premium", "insurance premium"), ("insurance_premium",)),
    (("utilities", "utility", "electricity", "bills"), ("utilities",)),
    (("essential expenses", "essentials", "living expenses"), ("essential_expenses",)),
    (("house goal", "house", "home goal"), ("house_goal",)),
    (("gold",), ("gold",)),
    (("car",), ("car_goal",)),
    (("food", "groceries"), ("food",)),
